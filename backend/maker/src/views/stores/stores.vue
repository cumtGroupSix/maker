<template>
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 col-sm-6 mb-3 flex mx-0 px-1" v-for="(store,index) in store" :key="index">
            ...
            return {
                store: [
                        ...
                        },
                        {
                            "storeId": 9,
                            "storeName": "凡奈诗韩版女鞋店",
                            "storeIntroduce": "该品牌创立于yyyy年",
                            "browseTimes": 222,
                            "imgUrl": "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=2456054635,3769338752&fm=26&gp=0.jpg",
                            "productGroupVOS": []
                        },
                        {
                            "storeId": 11,
                            ...
                            "storeIntroduce": "百年老店",
                            "browseTimes": 78,
                            "imgUrl": "https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2135299834,1746253257&fm=26&gp=0.jpg",
                            "productGroupVOS": []
                        },{
                            "storeId": 9,
                            "storeName": "凡奈诗韩版女鞋店",
