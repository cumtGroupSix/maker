				...
				<div v-if="dp">
					...
					<form>
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="introduction" rows="9" placeholder="这里是店铺介绍" v-model="storeIntroduction"></textarea>
						</div>					
					</form>
				...
				<div v-if="yc">
					<div id="bigScreen">
                        <table class="table table-hover" >
                            ...
                            <tbody>
                                <tr v-for = '(makerManage,index) in filterMakerManages' :key="index" style="background-color:#f6f5ec;border-radius:5px;margin:10px">
                                    ...
                                    <template v-if = 'makerManage.manageNumber %2 == 0'>
                                        <td  class="text-center">
                                            <button type="button"  class="btn btn-success del" @click = "delProduct(makerManage)">删除</button>
                                    ...
                                    <template v-else>
                                        <td  class="text-center">
                                        <!-- 创建点击事件-->
                                            <button type="button"  class="btn del" @click = "delProduct(makerManage)">删除</button>
					...
					<div id="smallScreen">
						<div v-for = '(makerManage,index) in filterMakerManages' :key="index" class="yc-small">
							<div class="row">
							...
							<template v-if = 'makerManage.manageNumber %2 == 0'>                               
                                <button type="button"  class="btn btn-sm btn-success del"  @click = "delProduct(makerManage)">删除</button>
                                <button type="button"  class="btn btn-sm btn-success" @click = "updateProduct(makerManage)" >修改</button>
                            </template>
                            <template v-else>
                             <!-- 创建点击事件-->
                                <button type="button"  class="btn btn-sm del"  @click = "delProduct(makerManage)">删除</button>
				...
				<div v-if="ddcl">
					<div id="bigScreen">
						<table class="table">
							...
							<tbody >
								<tr class="" v-for="(item,index) of makerOrder" :key="index">
					...
					<div id="smallScreen">
						<div class="row ddcl-small" v-for="(item,index) of makerOrder" :key="index">
							<div class="col-12 col-sm-6">
								<div>
